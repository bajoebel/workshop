				...
				<form>
					<div class="col-md-12">
					  <div class="input-group">
					    ...
					    <input type="text" class="form-control input-sm" id="qmedia" placeholder="Search" onkeyup="getMedia_download(0)">
...
<script src="<?php echo base_url() ."libjs/"; ?>download.js"></script> -->
