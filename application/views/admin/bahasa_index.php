                        ...
                        <div class="form-body">
                            <form action="#" class="form-horizontal" id="form" method="POST">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="email">Bahasa:</label>
                                    <div class="col-sm-8">
                                        <input type="hidden" id="bahasa_id" name="bahasa_id" >
                                        <input type="text" class="form-control" id="bahasa_nama" name="bahasa_nama" placeholder="Enter bahasa">
                                        <div class="text-error" id="err_bahasa"></div>
                                    </div>
