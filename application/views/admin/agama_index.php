                        ...
                        <div class="form-body">
                            <form action="#" class="form-horizontal" id="form" method="POST">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="email">Agama:</label>
                                    <div class="col-sm-8">
                                        <input type="hidden" id="id_agama" name="id_agama" placeholder="Enter Agama">
                                        <input type="text" class="form-control" id="agama" name="agama" placeholder="Enter Agama">
                                        <div class="text-error" id="err_agama"></div>
                                    </div>
