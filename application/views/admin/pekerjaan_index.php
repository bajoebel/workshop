                        ...
                        <div class="form-body">
                            <form action="#" class="form-horizontal" id="form" method="POST">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="email">Pekerjaan:</label>
                                    <div class="col-sm-8">
                                        <input type="hidden" id="pekerjaan_id" name="pekerjaan_id" >
                                        <input type="text" class="form-control" id="pekerjaan_nama" name="pekerjaan_nama" placeholder="Enter Pekerjaan">
                                        <div class="text-error" id="err_pekerjaan"></div>
                                    </div>
