                        ...
                        <div class="form-body">
                            <form action="#" class="form-horizontal" id="form" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="email">Caption:</label>
                                    <div class="col-sm-8">
                                        <input type="hidden" class="form-control" id="slider_id" name="slider_id">
                                        <input type="text" class="form-control" id="slider_caption" name="slider_caption" placeholder="Enter Caption">
                                        <div class="text-error" id="err_slider_caption"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="email">Urut:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="slider_urut" name="slider_urut" placeholder="Enter Urutan">
                                        <div class="text-error" id="err_slider_urut"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="text-error" id="err_slider_img"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="checkbox" value="1" name="slider_status" id="slider_status"> Aktif
                                        <div class="text-error" id="err_slider_status"></div>
                                    </div>
                                </div>
