                        ...
                        <div class="form-body">
                            <form action="#" class="form-horizontal" id="form" method="POST">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="email">Nama Negara:</label>
                                    <div class="col-sm-8">
                                        <input type="hidden" id="id_negara" name="id_negara" placeholder="Enter nama_negara">
                                        <input type="text" class="form-control" id="nama_negara" name="nama_negara" placeholder="Enter nama_negara">
