                        ...
                        <div class="form-body">
                            <form action="#" class="form-horizontal" id="form" method="POST">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="hidden" id="spesialis_id" name="spesialis_id" >
                                        <input type="text" class="form-control" id="spesialis_nama" name="spesialis_nama" placeholder="Enter spesialis">
                                        <div class="text-error" id="err_spesialis"></div>
                                    </div>
