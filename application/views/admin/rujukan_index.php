                        ...
                        <div class="form-body">
                            <form action="#" class="form-horizontal" id="form" method="POST">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="email">Rujukan:</label>
                                    <div class="col-sm-8">
                                        <input type="hidden" id="id_rujukan" name="id_rujukan" >
                                        <input type="text" class="form-control" id="rujukan" name="rujukan" placeholder="Enter rujukan">
                                        <div class="text-error" id="err_rujukan"></div>
                                    </div>
                                    
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="email">Faskes:</label>
                                    <div class="col-sm-8">
                                        <select name="jenis" id="jenis" class="form-control">
                                            <option value="0">Non Faskes</option>
                                            <option value="1">Faskes 1</option>
                                            <option value="2">Faskes 2</option>
                                            <option value="3">Kontrol Ulang</option>
                                        </select>
                                        <div class="text-error" id="err_rujukan"></div>
                                    </div>
