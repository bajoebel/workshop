...
//     var url = base_url+'admin/pasien/getdata?keyword=' + search + "&start=" + start + "&limit=" + limit +"&tgl=" + tgl+"&ruang=" + ruang
//     console.clear()
//     console.log(url)
//     $.ajax({
//         url     : url,
...
function hapus(id) {
    ...
    if (isConfirm) {
        $.ajax({
            url: base_url + "admin/pasien/batal/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data) {
                var start=$('#start').val();
...
function kembali(id) {
    ...
    if (isConfirm) {
        $.ajax({
            url: base_url + "admin/pasien/kembali/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data) {
                var start=$('#start').val();
